...
func (su seatUsecase) FindSeatByCinemaStudios(cinemaRequest model.SeatRequestByCinemaStudios) ([]model.SeatResponse, error){
	seats, err := su.seatRepository.GetSeatByCinemaStudios(cinemaRequest.CinemaStudiosID)
	if err!= nil{
        return nil, err
    }
